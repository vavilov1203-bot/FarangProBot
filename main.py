...
MENU_TREE: Dict[str, Any] = {
    ...
    "_children": {
        # =========================
        # 🧭 МОЯ СИТУАЦИЯ (НОВЫЙ ВХОД) + 2-Й УРОВЕНЬ С ЗАГЛУШКАМИ
        # =========================
                ...
                "🧳 Я только приехал": {
                    ...
                    "_children": {
                        "💱 Обмен денег — как сделать правильно": {
                            "_text": (
                                "Заглушка.\n\n"
                                "Здесь будет короткий гайд для новичка:\n"
                                "• где менять выгоднее\n"
                                "• как не попасть на подмену/фейки\n"
                                "• наличка, карты, крипта — что безопаснее\n\n"
                                "Пока можешь открыть основной раздел 👇"
                            ),
                            "_children": {
                        ...
                        "📄 Визовый статус — как понять, что у тебя сейчас": {
                            "_text": (
                                "Заглушка.\n\n"
                                "Здесь будет мини-чеклист:\n"
                                "• какой штамп/виза сейчас\n"
                                "• когда крайний срок\n"
                        ...
                        "🛡️ Страховка/медицина — что делать первым делом": {
                            "_text": (
                                "Заглушка.\n\n"
                                "Здесь будет простая схема:\n"
                                "• куда ехать при срочном\n"
                                "• как выбрать клинику\n"
                                "• как не переплатить без страховки\n\n"
                                "Пока можешь открыть основной раздел 👇"
                            ),
                            "_children": {
                ...
                "👨‍👩‍👦 Я с семьёй / ребёнок": {
                    ...
                    "_children": {
                        "🏠 Жильё для семьи — как выбирать": {
                            "_text": (
                                "Заглушка.\n\n"
                                "Здесь будет чеклист для семьи:\n"
                                "• район, транспорт, инфраструктура\n"
                                "• безопасность и условия в кондо\n"
                        ...
                        "📄 Визы для семьи — что реально тянется по деньгам": {
                            "_text": (
                                "Заглушка.\n\n"
                                "Здесь будет:\n"
                                "• какие варианты виз подходят семье\n"
                        ...
                        "🧰 Быт с ребёнком — транспорт/сервисы": {
                            "_text": (
                                ...
                                "• доставка/такси/связь\n"
                                "• базовая адаптация быта\n\n"
                                "Пока можешь открыть основной раздел 👇"
                            ),
                            "_children": {
                                "➡️ Открыть основной раздел: 🧰 Советы по быту и сервисы": {"_goto": ["🧰 Советы по быту и сервисы"]},
                    ...
                    "_children": {
                        "🧾 Шаг 1 — понять статус и сроки": {
                            "_text": (
                                "Заглушка.\n\n"
                                "Здесь будет:\n"
                                "• как понять свой текущий статус\n"
                                "• какие сроки критичны\n"
                                "• что нельзя просрочить\n\n"
                                "Пока можешь открыть основной раздел 👇"
                            ),
                            "_children": {
                                "➡️ Открыть основной раздел: 📄 Визы": {"_goto": ["📄 Визы"]},
                        ...
                        "💸 Шаг 2 — выбрать самый дешевый безопасный вариант": {
                            "_text": (
                                ...
                                "• ED / DTV / продления / семейные опции\n"
                                "• кому что подходит\n"
                                "• где чаще всего обманывают\n\n"
                                "Пока можешь открыть основной раздел 👇"
                            ),
                            "_children": {
                                "➡️ Открыть основной раздел: 📄 Визы": {"_goto": ["📄 Визы"]},
                    ...
                    "_children": {
                        ...
                        "💳 Если страховки нет — как не переплатить": {
                            "_text": (
                                "Заглушка.\n\n"
                                "Здесь будет:\n"
                                "• какие вопросы задавать по цене\n"
